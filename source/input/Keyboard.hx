// https://github.com/openfl/openfl/blob/develop/src/openfl/ui/Keyboard.hx
package input;
...
{
	public static var toStringMap:Map<Int, String> = [
		48 => "Zero", 49 => "One", 50 => "Two", 51 => "Three", 52 => "Four", 53 => "Five", 54 => "Six", 55 => "Seven", 56 => "Eight", 57 => "Nine", 65 => "A",
		...
		96 => "Numpad Zero", 97 => "Numpad One", 98 => "Numpad Two", 99 => "Numpad Three", 100 => "Numpad Four", 101 => "Numpad Five", 102 => "Numpad Six",
		103 => "Numpad Seven", 104 => "Numpad Eight", 105 => "Numpad Nine", 106 => "Numpad Multiply", 107 => "Numpad Add", 108 => "Numpad Enter",
		109 => "Numpad Subtract", 110 => "Numpad Decimal", 111 => "Numpad Divide", 112 => "F1", 113 => "F2", 114 => "F3", 115 => "F4", 116 => "F5",
		117 => "F6", 118 => "F7", 119 => "F8", 120 => "F9", 121 => "F10", 122 => "F11", 123 => "F12", 124 => "F13", 125 => "F14", 126 => "F15",
		8 => "Backspace", 9 => "Tab", 18 => "Alt", 13 => "Enter", 15 => "Command", 16 => "Shift", 17 => "Control", 19 => "Break", 20 => "Caps Lock",
		21 => "Numpad ?", 27 => "Escape", 32 => "Space", 33 => "Page Up", 34 => "Page Down", 35 => "End", 36 => "Home", 37 => "Left", 39 => "Right",
		38 => "Up", 40 => "Down", 45 => "Insert", 46 => "Delete", 144 => "Num Lock", 186 => "Semicolon", 187 => "Equal", 188 => "Comma", 189 => "Minus",
		190 => "Period", 191 => "Slash", 192 => "Backquote", 219 => "Left Bracket", 220 => "Backslash", 221 => "Right Bracket", 222 => "Quote"
	];
	...
	**/
	...
	@:noCompletion private static inline function __convertKeyCode(key:KeyCode):Int
	{
		return switch (key)
		{
			...
			case KeyCode.EXCLAMATION: Keyboard.ONE;
			case KeyCode.QUOTE: Keyboard.QUOTE;
			case KeyCode.HASH: Keyboard.THREE;
			case KeyCode.DOLLAR: Keyboard.FOUR;
			case KeyCode.PERCENT: Keyboard.FIVE;
			case KeyCode.AMPERSAND: Keyboard.SEVEN;
			case KeyCode.SINGLE_QUOTE: Keyboard.QUOTE;
			case KeyCode.LEFT_PARENTHESIS: Keyboard.NINE;
			case KeyCode.RIGHT_PARENTHESIS: Keyboard.ZERO;
			case KeyCode.ASTERISK: Keyboard.EIGHT;
			...
			case KeyCode.NUMBER_0: Keyboard.ZERO;
			case KeyCode.NUMBER_1: Keyboard.ONE;
			case KeyCode.NUMBER_2: Keyboard.TWO;
			case KeyCode.NUMBER_3: Keyboard.THREE;
			case KeyCode.NUMBER_4: Keyboard.FOUR;
			case KeyCode.NUMBER_5: Keyboard.FIVE;
			case KeyCode.NUMBER_6: Keyboard.SIX;
			case KeyCode.NUMBER_7: Keyboard.SEVEN;
			case KeyCode.NUMBER_8: Keyboard.EIGHT;
			case KeyCode.NUMBER_9: Keyboard.NINE;
			...
			case KeyCode.CARET: Keyboard.SIX;
			...
			case KeyCode.NUMPAD_1: Keyboard.NUMPAD_ONE;
			case KeyCode.NUMPAD_2: Keyboard.NUMPAD_TWO;
			case KeyCode.NUMPAD_3: Keyboard.NUMPAD_THREE;
			case KeyCode.NUMPAD_4: Keyboard.NUMPAD_FOUR;
			case KeyCode.NUMPAD_5: Keyboard.NUMPAD_FIVE;
			case KeyCode.NUMPAD_6: Keyboard.NUMPAD_SIX;
			case KeyCode.NUMPAD_7: Keyboard.NUMPAD_SEVEN;
			case KeyCode.NUMPAD_8: Keyboard.NUMPAD_EIGHT;
			case KeyCode.NUMPAD_9: Keyboard.NUMPAD_NINE;
			case KeyCode.NUMPAD_0: Keyboard.NUMPAD_ZERO;
			...
			// case KeyCode.NUMPAD_ZERO0: 0x400000B0;
			// case KeyCode.NUMPAD_ZERO00: 0x400000B1;
	...
	@:noCompletion private static function __getCharCode(key:Int, shift:Bool = false):Int
	{
		if (!shift)
		{
			...
			if (key >= Keyboard.ZERO && key <= Keyboard.NINE)
			{
				return key - Keyboard.ZERO + 48;
			}
		...
		if (key >= Keyboard.NUMPAD_ZERO && key <= Keyboard.NUMPAD_NINE)
		{
			return key - Keyboard.NUMPAD_ZERO + 48;
		}
